...
sc.rna.mu.scale <- readRDS('../Input/toxo_cdc/rds_ME49_59/sc_rna_spline_mu_scale_rna_trans.rds')
sc.atac.mu.scale <- readRDS('../Input/toxo_cdc/rds_ME49_59/sc_atac_spline_mu_scale_atac_trans.rds')
...
DEGs.rna.trans <- readRDS("../Input/toxo_cdc/rds_ME49_59/rna_markers_rna_trns_sig_v2_sum_plt.rds")
...
tss.df.all <- readRDS("../Input/toxo_cdc/rds_ME49_59/motif_dist_from_TSS_plt.rds")
...
## fig 9 A
```{r}
AP2.clusters <- readRDS('../Input/toxo_cdc/rds_ME49_59/Cyclic_33_AP2s_sc_rna_sc_atac_dtw_4_clust.rds')
...
IMC.clusters <- readRDS('../Input/toxo_cdc/rds_ME49_59/IMC_sc_rna_sc_atac_joint_dtw_clust_new_update.rds')
...
```
```{r}
BCs_clusters <- readRDS('../Input/toxo_cdc/rds_ME49_59/BC_sc_rna_sc_atac_joint_dtw_clust_new_update.rds')
...
```{r}
sc.rna.mu.scale.v2 <- readRDS('../Input/toxo_cdc/rds_ME49_59/sc_rna_spline_mu_scale_rna_trans_ord_by_atac.rds')
sc.atac.mu.scale.v2 <- readRDS('../Input/toxo_cdc/rds_ME49_59/sc_atac_spline_mu_scale_atac_trans_ord_by_atac.rds')
