...
saveRDS(L.rna$genes.df, '../Input/toxo_cdc/rds_ME49_59/sc_rna_genes_expr_pt.rds')
saveRDS(L.atac$genes.df, '../Input/toxo_cdc/rds_ME49_59/sc_atac_genes_expr_pt.rds')

saveRDS(L.rna$sds.data, '../Input/toxo_cdc/rds_ME49_59/sc_rna_sds_data.rds')
saveRDS(L.atac$sds.data, '../Input/toxo_cdc/rds_ME49_59/sc_atac_sds_data.rds')

saveRDS(L.rna$S.O, '../Input/toxo_cdc/rds_ME49_59/S.O_intra_lables_pt.rds')
saveRDS(L.atac$S.O, '../Input/toxo_cdc/rds_ME49_59/S.O_intra_atac_lables_pt.rds')
